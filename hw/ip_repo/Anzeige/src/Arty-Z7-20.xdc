...
create_clock -add -name clk_color -period 10.00 -waveform {0 5} [get_ports { i_clk }];#set
create_clock -add -name clk_vga -period 20.00 -waveform {0 10} [get_ports { i_vga_clk }];#set
create_clock -add -name clk_soc -period 10.00 -waveform {0 5} [get_ports { s00_axi_aclk }];#set
