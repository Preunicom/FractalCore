...
## Clock Signal
#set_property -dict { PACKAGE_PIN H16    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name clk_init -period 20.00 -waveform {0 10} [get_ports { i_clk_init }];#set
create_clock -add -name clk_calc -period 10.00 -waveform {0 5} [get_ports { i_clk_calc }];#set
