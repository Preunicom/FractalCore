...
# No CDC as we use phase related clocks in this case
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { ext_rst }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { o_vga_h_sync_0 }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { o_vga_v_sync_0 }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
