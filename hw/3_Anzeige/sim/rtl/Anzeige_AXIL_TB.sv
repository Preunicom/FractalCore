...
module Anzeige_TB();
  ...
  logic i_highlight_ch0_valid_0 = 1;
  logic [9:0] i_highlight_ch0_current_pixel_col_0 = 0;
  logic [8:0] i_highlight_ch0_current_pixel_row_0 = 0;
  logic [9:0] i_highlight_ch0_target_pixel_col_0 = 10;
  logic [8:0] i_highlight_ch0_target_pixel_row_0 = 10;
  logic i_highlight_ch1_valid_0 = 0;
  logic [9:0] i_highlight_ch1_current_pixel_col_0 = 0;
  logic [8:0] i_highlight_ch1_current_pixel_row_0 = 0;
  logic [9:0] i_highlight_ch1_target_pixel_col_0 = 0;
  logic [8:0] i_highlight_ch1_target_pixel_row_0 = 0;
  logic i_highlight_ch2_valid_0 = 1;
  logic [9:0] i_highlight_ch2_current_pixel_col_0 = 331;
  logic [8:0] i_highlight_ch2_current_pixel_row_0 = 190;
  logic [9:0] i_highlight_ch2_target_pixel_col_0 = 639;
  logic [8:0] i_highlight_ch2_target_pixel_row_0 = 400;
  logic i_highlight_ch3_valid_0 = 0;
  logic [9:0] i_highlight_ch3_current_pixel_col_0 = 0;
  logic [8:0] i_highlight_ch3_current_pixel_row_0 = 0;
  logic [9:0] i_highlight_ch3_target_pixel_col_0 = 0;
  logic [8:0] i_highlight_ch3_target_pixel_row_0 = 0;
  ...
  VIP_AXIL_Anzeige_TB_wrapper DUT( // TODO: Check signals!
    ...
    .i_highlight_ch0_current_pixel_col_0(i_highlight_ch0_current_pixel_col_0),
    .i_highlight_ch0_current_pixel_row_0(i_highlight_ch0_current_pixel_row_0),
    .i_highlight_ch0_target_pixel_col_0(i_highlight_ch0_target_pixel_col_0),
    .i_highlight_ch0_target_pixel_row_0(i_highlight_ch0_target_pixel_row_0),
    .i_highlight_ch1_valid_0(i_highlight_ch1_valid_0),
    .i_highlight_ch1_current_pixel_col_0(i_highlight_ch1_current_pixel_col_0),
    .i_highlight_ch1_current_pixel_row_0(i_highlight_ch1_current_pixel_row_0),
    .i_highlight_ch1_target_pixel_col_0(i_highlight_ch1_target_pixel_col_0),
    .i_highlight_ch1_target_pixel_row_0(i_highlight_ch1_target_pixel_row_0),
    .i_highlight_ch2_valid_0(i_highlight_ch2_valid_0),
    .i_highlight_ch2_current_pixel_col_0(i_highlight_ch2_current_pixel_col_0),
    .i_highlight_ch2_current_pixel_row_0(i_highlight_ch2_current_pixel_row_0),
    .i_highlight_ch2_target_pixel_col_0(i_highlight_ch2_target_pixel_col_0),
    .i_highlight_ch2_target_pixel_row_0(i_highlight_ch2_target_pixel_row_0),
    .i_highlight_ch3_valid_0(i_highlight_ch3_valid_0),
    .i_highlight_ch3_current_pixel_col_0(i_highlight_ch3_current_pixel_col_0),
    .i_highlight_ch3_current_pixel_row_0(i_highlight_ch3_current_pixel_row_0),
    .i_highlight_ch3_target_pixel_col_0(i_highlight_ch3_target_pixel_col_0),
    .i_highlight_ch3_target_pixel_row_0(i_highlight_ch3_target_pixel_row_0)
  );
  ...
  task automatic rst_n_sequence(input integer unsigned width = 20);
    @(posedge i_clk);
    #1ns;
    i_rst_n = 0;
    repeat (width) @(posedge i_clk);
    #1ns;
    i_rst_n = 1;
  endtask
  ...
  task automatic SET_COLORS;
    ...
    for (int i = 25; i <= 100; i++) begin
      current_addr = COL_ITER_BASE_ADDR + (i * 4);
      blocking_write_register(current_addr, 32'h0000FF00); // Green
    end
    blocking_write_register(COL_CONV_ADDR, 32'h00FF0000); // Blue
    blocking_write_register(COL_PIXEL_MASK, 32'h0000FFFF); // Yellow
    blocking_write_register(COL_TARGET_MASK, 32'h00FFFF00); // Magenta
  endtask
