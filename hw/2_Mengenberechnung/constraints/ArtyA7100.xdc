...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { i_clk_init }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name clk_init -period 20.00 -waveform {0 5} [get_ports { i_clk_init }];
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { i_clk_calc }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name clk_calc -period 10.00 -waveform {0 5} [get_ports { i_clk_calc }];
