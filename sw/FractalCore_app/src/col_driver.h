...
#define COL_ITER_BASE_ADDR_OFFSET_END 	0x190
#define COL_CONV_ADDR_OFFSET      		0x194
#define COL_MINIMAP_TARGET_ADDR_OFFSET  0x198
#define COL_MINIMAP_PIXEL_ADDR_OFFSET   0x19C
